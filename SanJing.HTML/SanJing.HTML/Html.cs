...
namespace SanJing.HTML
{
    ...
    public static class Html
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(htmlCode)) return new HtmlTag[0];
        ...
        {
            if (string.IsNullOrWhiteSpace(htmlCode)) return null;
        ...
        {
            if (string.IsNullOrWhiteSpace(htmlCode)) return string.Empty;
        ...
        {
            if (string.IsNullOrWhiteSpace(htmlCode)) return new string[0];
